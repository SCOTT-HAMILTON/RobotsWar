    ...
    ScriptCommand("move"), offsetx(x), offsety(y)
{
    ...
    if (offsetx.type == CONSTANT)props.insert(std::pair<std::string, float*>("offsetx", &offsetx.floatval));
    else{
        offsetx.floatval = NAN;
        props.insert(std::pair<std::string, float*>("offsetx", &offsetx.floatval));
    ...
    if (offsety.type == CONSTANT)props.insert(std::pair<std::string, float*>("offsety", &offsety.floatval));
    else{
        offsety.floatval = NAN;
        props.insert(std::pair<std::string, float*>("offsety", &offsety.floatval));
